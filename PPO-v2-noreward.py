...
from rl_env_v2_noreward import Myenv, UPPERBOUND
...
class PPO():
    ...
    def __init__(self, mode='train'):
        ...
        self.mode = mode
        self.writer = SummaryWriter('./expnoreward')
    ...
    def save_param(self):
        actor_file = './param/net_paramnoreward/actor_net' + str(time.time())[:10] + '.pkl'
        critic_file = './param/net_paramnoreward/critic_net' + str(time.time())[:10] + '.pkl'
...
def main():
    ...
    # agent.load_param(('param/net_param/actor_net1647524269.pkl', 'param/net_param/critic_net1647524269.pkl'))
...
if __name__ == '__main__':
    main()
    print("end")
    # test(('param/net_param/actor_net1647221448.pkl', 'param/net_param/critic_net1647221448.pkl'), 0)
