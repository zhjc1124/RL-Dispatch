...
class Actor(nn.Module):
    def __init__(self):
        ...
        self.fc1 = nn.Linear(117*116, 300)
        self.fc2 = nn.Linear(300, 20 - 1)
        self.action_head = nn.Linear(196, 118)
    ...
    def forward(self, state):
        ...
        for i in range(in_size):
            ...
            x = torch.concat((info, dispatch, t), 1).view(1, 1, 16, -1)
            x = self.conv4(x)
            x = F.relu(x)
            x = x.view(1, -1)
...
class Critic(nn.Module):
    def __init__(self):
        ...
        self.fc1 = nn.Linear(117*116, 300)
        self.fc2 = nn.Linear(300, 20 - 1)
        self.value_head = nn.Linear(196, 1)
