...
from rl_env_v3 import Myenv, UPPERBOUND
...
class PPO():
    ...
    def update(self, i_ep):
        ...
        old_action_log_prob = torch.cat([t.a_log_prob for t in self.buffer], dtype=torch.float).view(-1, 1)
        ...
        for i in range(self.ppo_update_time):
            for index in BatchSampler(SubsetRandomSampler(range(len(self.buffer))), self.batch_size, False):
                ...
                action_loss = -torch.min(surr1, surr2)  # MAX->MIN desent
...
def main():
    ...
    agent.load_param(('param/net_param/actor_net1647343595.pkl', 'param/net_param/critic_net1647343595.pkl'))
...
if __name__ == '__main__':
    main()
    print("end")
    # test(('param/net_param/actor_net1647343595.pkl', 'param/net_param/critic_net1647343595.pkl'), 0)
