...
class PPO():
    ...
    def __init__(self, mode='train'):
        ...
        self.mode = mode
        self.writer = SummaryWriter('./expslow')
    ...
    def save_param(self):
        actor_file = './param/net_paramslow/actor_net' + str(time.time())[:10] + '.pkl'
        critic_file = './param/net_paramslow/critic_net' + str(time.time())[:10] + '.pkl'
...
def main():
    ...
    agent.load_param(('param/net_param/actor_net1647573931.pkl', 'param/net_param/critic_net1647573931.pkl'))
